...
class LineFollower(Node):
	...
	def edge_vectors_callback(self, message):
		...
		# TODO: participants are expected to gradually increase speed to improve time.
		speed = 0.25  # hardcoding speed to 0.25 for careful operation with h/w buggy.
	...
	def lidar_callback(self, message):
		...
		# Get the front half of the ranges array returned by the LIDAR.
